 ...
 * @author maurh
 */
public final class menuBetJockey extends javax.swing.JFrame {

    Sistema sistema;
    private String betGuy = "";
    private int INDEXX;
    private boolean statusReturn = false;
    private Jockey temp1= new Jockey("Juan");
    private Jockey temp2;
    ...
    public menuBetJockey(Sistema sistema, int index) {
        ...
        this.sistema = sistema;
            ...
            jP1.setText(sistema.getHorseRace().getJockeys().elemInd(index).getName());
            temp1 = sistema.getHorseRace().getJockeys().elemInd(index);
            this.jLPC1.setText("quota " + String.valueOf(Operations.betJockey(temp1)));
    ...
    public boolean winner(HorseRace h) {
        int i = h.playRace(temp1);
    ...
    private void btnLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogActionPerformed
        ...
        try {
            ...
            Float  m = Float.valueOf(jTextField1.getText());
            if (mount >= 50 && aux.getMount() >= mount && betGuy != null) {
                ...
                if (z == JOptionPane.YES_OPTION) {               
                    ...
                    MenuRace.msg("Iniciando carrera");
                    //
                  boolean won=  sistema.betJ(mount, winner(sistema.getHorseRace()), temp1);
                    statusReturn = true;
                    MenuRace.msg("Termino la carrera");
