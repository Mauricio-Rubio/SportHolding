...
public class ArbolBinarioBusqueda<T extends Comparable<T>> extends ArbolBinario<T> {
  ...
  protected Cola<T> modBFS(ArbolBinario<T> arbolE) {
 ...
 */
public ArbolBinarioBusqueda<T> convertBST(ArbolBinario<T> arb){
 ...
 Lista<T> lista = new Lista<T>();
  ...
  ArbolBinarioBusqueda<T> nuevo = new ArbolBinarioBusqueda<T>(lista,true);
    return nuevo;
}
